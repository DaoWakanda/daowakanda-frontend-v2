        ...
        <div className="relative flex flex-col ">
          <div className="">
            <div className="flex flex-col justify-center text-center gap-1 mb-8">
              <h2 className="text-white text-[24px] font-avenir font-black md:text-[40px]">
                Join Our Community
              </h2>
              <p className="text-[16px] font-plusJarkata text-[#919094] md:text-[24px]">
                Be part of the community and have a say in the future of the Algorand Nigeria
                community
              </p>
            </div>
            <div className="grid grid-cols-2 grid-rows-3 gap-4 md:grid-cols-3 md:grid-rows-2  min-h-[302px] mb-16">
              <Link href="https://t.me/daowakanda" target="_blank" rel="noopener noreferrer">
                <div className="flex w-full  p-4 rounded-[16px] bg-[#1E1E1E] cursor-pointer gap-4  items-center hover:bg-[#056da1] transition duration-100 ease-in-out">
                  <div className="w-[50px] h-[50px] md:w-[100.25px] md:h-[100px] ">
                    <img
                      src="https://res.cloudinary.com/dlinprg6k/image/upload/v1743279224/telegram_crbgnz.png"
                      alt=""
                    />
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[#919094] text-sm font-plusJarkata md:text-[16px]">
                      Join chat
                    </p>
                  </div>
                </div>
              </Link>
              <Link href="https://x.com/DaoWakanda" target="_blank" rel="noopener noreferrer">
                <div className="flex w-full  p-4 rounded-[16px] bg-[#1E1E1E] cursor-pointer gap-4 items-center hover:bg-black transition duration-100 ease-in-out">
                  <div className="w-[50px] h-[50px] md:w-[100px] md:h-[100px]">
                    <img
                      src="https://res.cloudinary.com/dlinprg6k/image/upload/v1743279224/x_sosgwc.png"
                      alt=""
                    />
                  </div>
                  <div className="flex flex-col">
                    <h2 className="font-avenir text-[16px] font-black md:text-[24px]">
                      Twitter(x)
                    </h2>
              ...
              >
                <div className="flex w-full  p-4 rounded-[16px] bg-[#1E1E1E] cursor-pointer gap-4 items-center hover:bg-[#cd62161f] transition duration-100 ease-in-out">
                  <div className="w-[50px] h-[50px] md:w-[102.4px] md:h-[99.8px]">
                    <img
                      src="https://res.cloudinary.com/dlinprg6k/image/upload/v1743279224/github_swt7hk.png"
                      alt=""
                    />
                  </div>
                  <div className="flex flex-col">
              ...
              <div className="flex w-full  p-4 rounded-[16px] bg-[#1E1E1E] cursor-pointer gap-4 items-center">
                <div className="w-[50px] h-[50px] md:w-[100.25px] md:h-[100px]">
                  <img
                    src="https://res.cloudinary.com/dlinprg6k/image/upload/v1743279223/envelope_n0o0bx.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col">
              ...
              <Link href="https://medium.com/@daowakanda" target="_blank" rel="noopener noreferrer">
                <div className="flex w-full  p-4 rounded-[16px] bg-[#1E1E1E] cursor-pointer gap-4 col-span-2 items-center">
                  <div className="w-[50px] h-[50px] md:w-[100px] md:h-[100px]">
                    <img
                      src="https://res.cloudinary.com/dlinprg6k/image/upload/v1743279223/blog_uth15p.png"
                      alt=""
                    />
                  </div>
                  <div className="flex flex-col">
                    <h2 className="font-avenir text-[16px] font-black md:text-[24px]">Blog</h2>
                    <p className="text-[#919094] text-sm font-plusJarkata">
                      learn about daowakanda
                    </p>
                  </div>
                </div>
              </Link>
          ...
          <div className=" flex flex-col text-center justify-center h-[270px] gap-8 ">
            <div className="flex flex-col gap-1">
              <h3 className="text-[20px] font-avenir font-black md:text-[40px]">
                Subscribe to our mailing list
              </h3>
              <p className="font-plusJarkata text-[16px] text-[#919094] md:text-[24px]">
            ...
            <div>
              <form className="border-green-700 relative md:w-[629px] md:h-[64px] mx-auto">
                ...
                <button
                  type="submit"
                  className="absolute bg-black h-[40px]  top-[8px] md:top-[5px] right-[8px]  rounded-[100px] w-[126px] py-2 px-8 font-avenir text-sm font-black cursor-pointer md:h-[48px] md:w-[153px] text-[20px] "
                >
                  Subscribe
                </button>
              </form>
