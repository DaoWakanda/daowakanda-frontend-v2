    ...
    <>
      <div>
        <div className="min-h-[975px] lg:h-[1024px] flex  relative pt-[100px]">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[rgba(0,0,0,.99)] to-[rgba(0,0,0,.2)]"></div>
          <PageMaxWidth>
            <div className="text-white  z-[1] relative  h-[100%] pt-[150px]  md:w-[60%] lg:w-[526px] ">
              <div className=" flex flex-col min-h-[344px] items-center text-center md:text-left gap-[32px]">
                <div className="flex flex-col ">
                  <h1 className="text-[61px] font-avenir font-extrabold text-greenColor tracking-[-0.28px] lg:leading-[95.1px] lg:text-[90px] pb-3">
                    DaoWakanda
                  </h1>
                  <div className="font-[350px]  font-avenirLtsd text-[20px]  px-3  ">
                    This is a decentralized autonomous organization to revolutionize community
                    engagement and participation within Algorand Nigeria.
                  </div>
                </div>
                <div className="flex gap-8 flex-col md:flex-row mr-auto w-[100%] items-center">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <span>
                      <img
                        src="https://res.cloudinary.com/dk5mfu099/image/upload/v1741874494/play-circle_r4wiwx.png"
                        alt=""
                      />
                    </span>
              ...
              <div className=" mt-[94px] h-[72px]  relative px-1 md:mt-[20px] md:h-[94px] ">
                ...
                <div className="relative z-10  flex gap-[22px] justify-evenly items-center h-[100%] font-plusJarkata">
                  <div className=" flex gap-2 items-center">
                    ...
                    <p className="text-[10px] font-normal flex flex-col pr-2 text-left md:text-[13px]">
                      Active <span> Projects</span>
                    </p>
                  </div>
                  <div className=" h-[38px] w-[17px] my-auto">
                    <img
                      src="https://res.cloudinary.com/dk5mfu099/image/upload/v1741940721/Line_yob43x.svg"
                      alt=""
                    />
                  </div>
                  <div className=" flex gap-2 items-center">
