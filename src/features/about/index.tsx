...
export function About() {
  return (
    <div className="w-full min-h-screen flex flex-col items-start pt-20 md:pt-[120px]">
      <div
        className="hidden sm:block w-full h-[150px] bg-cover bg-center"
        style={{ backgroundImage: `url(${background.src})` }}
      ></div>

      {/* Background */}

      <div className="flex flex-col m-2 md:m-16 font-spaceGrotesk">
        <div className="pt-0 w-full">
          <h1 className="text-[24px] md:text-[32px] text-[#CAFFBB] font-[700]">Background</h1>
        ...
        <div className="flex w-full h-auto sm:h-[332px] mt-10 md:mt-20 gap-8 flex-col sm:flex-row">
          ...
          <div className="order-1 sm:order-2 flex-1 flex items-center justify-center sm:justify-end">
            <div className="w-full sm:w-[70%] h-[250px] sm:h-[300px] overflow-hidden">
              <img src={pic.src} alt="Frame" className="w-full h-full" />
            </div>
          </div>
        ...
        <div className="flex justify-between text-white w-full h-[250px] mt-10 mb-10 md:mt-20 md:mb-0 gap-4 flex-col sm:flex-row">
          ...
          <div className="w-full border border-[#fff] rounded-lg  p-[16px]">
            <div className="flex flex-col w-full h-full">
              ...
              <p className="text-sm pt-5">
                DAO Wakanda is built on the Algorand blockchain, known for its speed, security, and
                scalability. This section will detail the technical architecture, smart contracts,
                and how NFTs integrate with the DAO.
              </p>
            </div>
          </div>
          <div className="w-full border border-[#fff] rounded-lg  p-[16px]">
