  ...
  return (
    <div className='rounded-[30px] p-8 shadow-lg backdrop-blur-sm bg-[#1F2431] w-full  mx-auto mb-[50px] flex flex-col md:gap-3'>
      <div>
        ...
        <div className='flex md:hidden flex-col mb-8 text-center justify-center'>
        <div className="w-6 h-6  rounded mb-2 mx-auto md:hidden">
        <img src="https://res.cloudinary.com/dlinprg6k/image/upload/v1730052651/Group_5_1_nmdiwy.png" alt="" />
         </div>
            <h1 className='text-[24px] mb-1 font-bold text-[#C5EE4F] font-avenir'>Let's Know Who You Are.</h1>
