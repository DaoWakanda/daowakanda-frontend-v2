...
import { getCountryOptions, getStateOptions, LocationOption } from '@/utils/location';
import StateSelect from '../form-field/state-select';
import CountrySelect from '../form-field/country-select';
...
const [loadingStates, setLoadingStates] = useState(false);
  ...
  const fetchStates = (countryIsoCode: string) => {
    ...
    // sync util, but we keep loading for UX consistency
    const stateOptions = getStateOptions(countryIsoCode);
